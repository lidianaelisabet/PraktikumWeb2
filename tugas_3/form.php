...
<body>
  ...
  <div class="form-group row">
        ...
        echo "Program Studi : " . $program . "<br>";
        echo "Skill Web & Programming : "  ."<br>";
        foreach ($skill as $s) {
            echo $s . ",";
        }
